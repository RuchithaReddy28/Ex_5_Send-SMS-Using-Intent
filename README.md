...
```
## Output:
![output](https://github.com/RuchithaReddy28/Ex_5_Send-SMS-Using-Intent/blob/main/aa.png?raw=true)
![output](https://github.com/RuchithaReddy28/Ex_5_Send-SMS-Using-Intent/blob/main/aaa.png?raw=true)
